// Checkers take an AST node and return a `Type` (./typechecker/types).
// They also might collect definitions when it makes sense (variables,
// functions), and add type information to the node they receive when needed.
//
// They are also in charge of throwing an error if the action is invalid, thus,
// performing the actual type-checking (eg: calling a function with invalid
// arguments).
