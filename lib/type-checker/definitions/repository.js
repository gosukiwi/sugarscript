class Repository {
  ...
  getQuery (parts, accu) {
    ...
    const value = parts[0].type === 'IDENTIFIER' ? this.getIdentifier(parts[0].value) : this.getIdentifier(parts[0].identifier)
