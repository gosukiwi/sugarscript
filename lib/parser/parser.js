...
const parser = new Parser({
  ...
  bnf: {
    ...
    for: [
      ['FOR IDENTIFIER = number TO expression STEP number newlines INDENT substatements DEDENT', '$$ = yy.ast("for", $2, $4, $6, $8, $11)'],
      ['FOR IDENTIFIER = number TO expression newlines INDENT substatements DEDENT', '$$ = yy.ast("for", $2, $4, $6, null, $9)'],
