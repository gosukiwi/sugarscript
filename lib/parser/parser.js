...
const parser = new Parser({
  bnf: {
    ...
    if: [
      // IF ELSE
      ['IF subexpression NEWLINE INDENT substatements DEDENT if_tail', '$$ = yy.ast.if_node($2, $5, $7)'],
      // IF
      ['IF subexpression NEWLINE INDENT substatements DEDENT', '$$ = yy.ast.if_node($2, $5)']
    ],
    if_tail: [
      ['ELIF subexpression NEWLINE INDENT substatements DEDENT if_tail', '$$ = yy.ast.elif_node($2, $5, $7)'],
      ['ELIF subexpression NEWLINE INDENT substatements DEDENT', '$$ = yy.ast.elif_node($2, $5)'],
      ['ELSE NEWLINE INDENT substatements DEDENT', '$$ = yy.ast.elif_node(null, $4)']
    ],
    // FUNCTIONS
    // =========================================================================
    function: [
