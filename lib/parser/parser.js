...
const parser = new Parser({
  bnf: {
    ...
    if: [
      // IF ELSE
      ['IF subexpression NEWLINE INDENT substatement DEDENT if_tail', '$$ = yy.ast.if_node($2, $5, $7)'],
      // IF
      ['IF subexpression NEWLINE INDENT substatement DEDENT', '$$ = yy.ast.if_node($2, $5)']
    ],
    if_tail: [
      ['ELIF subexpression NEWLINE INDENT substatement DEDENT if_tail', '$$ = yy.ast.if_node($2, $5, $7)'],
      ['ELIF subexpression NEWLINE INDENT substatement DEDENT', '$$ = yy.ast.if_node($2, $5)'],
      ['ELSE NEWLINE INDENT substatement DEDENT', '$$ = yy.ast.if_node(null, $4)']
    ],
    // FUNCTIONS
    // =========================================================================
    function: [
