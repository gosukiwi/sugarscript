...
const parser = new Parser({
  ...
  bnf: {
    ...
    substatement: [
      ...
      ['with', '$$ = $1'],
      ['return', '$$ = $1'],
      ['HALT string newlines', '$$ = yy.ast("halt", $2)'],
    ...
    plugin_import: [
      ['IMPORT_PLUGIN identifier AS identifier newlines', '$$ = yy.ast("pluginImport", $2, $4)'],
      ['IMPORT_PLUGIN identifier newlines', '$$ = yy.ast("pluginImport", $2, $2)']
    ],
    // [STATEMENTS] ============================================================
    call: [
    ...
    plugin_call: [
      ['IDENTIFIER :: IDENTIFIER ( arguments ) : typehint', '$$ = yy.ast("pluginCall", $1, $3, $5, $8)'],
      ['IDENTIFIER :: IDENTIFIER ( ) : typehint', '$$ = yy.ast("pluginCall", $1, $3, [], $7)']
    ],
    let: [
    ...
    // =========================================================================
    with: [
      ['WITH expression NEWLINE INDENT with_body DEDENT', '$$ = yy.ast("with", $2, $5)']
    ],
    with_body: [
      ['with_clauses with_else_clause', '$$ = $1.concat($2)']
    ],
    with_clauses: [
      ['with_clauses with_clause', '$$ = $1.concat($2).flat()'],
      ['with_clause', '$$ = [$1].flat()']
    ],
    with_clause: [
      ['WHEN identifier : typehint NEWLINE INDENT substatements DEDENT', '$$ = yy.ast("withClause", $2, $4, $7)'],
      ['WHEN identifier : ( with_type_list ) NEWLINE INDENT substatements DEDENT', '$$ = yy.ast("withMultipleClause", $2, $5, $9)']
    ],
    with_type_list: [
      ['with_type_list | typehint', '$$ = $1.concat($3)'],
      ['typehint', '$$ = [$1]']
    ],
    with_else_clause: [
      ['ELSE NEWLINE INDENT substatements DEDENT', '$$ = yy.ast("withElseClause", $4)']
    ],
    // TYPE DEFINITION
    // =========================================================================
    type_definition: [
    ...
    // =========================================================================
    union_definition: [
      ['TYPE identifier ( union_types_list ) newlines', '$$ = yy.ast("unionDefinition", $2, $4)']
    ],
    union_types_list: [
      ['union_types_list | identifier', '$$ = $1.concat($3)'],
      ['identifier', '$$ = [$1]']
    ],
    // IF
    // =========================================================================
    if: [
      // IF ELSE
      ['IF subexpression newlines INDENT substatements DEDENT if_tail', '$$ = yy.ast("ifNode", $2, $5, $7)'],
      // IF
      ['IF subexpression newlines INDENT substatements DEDENT', '$$ = yy.ast("ifNode", $2, $5)'],
      ['IF subexpression THEN substatement', '$$ = yy.ast("ifNode", $2, [$4])'],
      ['UNLESS subexpression THEN substatement', '$$ = yy.ast("unlessNode", $2, [$4])']
    ],
    if_tail: [
      ['ELIF subexpression newlines INDENT substatements DEDENT if_tail', '$$ = yy.ast("elifNode", $2, $5, $7)'],
      ['ELIF subexpression newlines INDENT substatements DEDENT', '$$ = yy.ast("elifNode", $2, $5)'],
      ['ELSE newlines INDENT substatements DEDENT', '$$ = yy.ast("elifNode", null, $4)']
    ],
    // LOOPS
    // =========================================================================
    while: [
    ...
    for: [
      ...
      ['FOR IDENTIFIER = expression TO expression STEP expression DO substatement', '$$ = yy.ast("for", $2, $4, $6, $8, [$10])'],
      ['FOR IDENTIFIER = expression TO expression DO substatement', '$$ = yy.ast("for", $2, $4, $6, null, [$8])'],
      ['FOR IDENTIFIER IN expression DO substatement', '$$ = yy.ast("foreach", $2, $4, [$6])']
    ],
    // FUNCTIONS
    // =========================================================================
    function: [
    ...
    // =========================================================================
    list_comprehension: [
      ['[ subexpression FOR identifier IN expression WHEN subexpression ]', '$$ = yy.ast("listComprehension", $2, $4, $6, $8)'],
      ['[ subexpression FOR identifier IN expression ]', '$$ = yy.ast("listComprehension", $2, $4, $6, null)']
    ],
    array_access: [
