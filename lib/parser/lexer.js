...
const TOKENS = [
  ...
  new StringToken({ name: 'NOT', match: 'not' }),
  new StringToken({ name: 'AND', match: 'and' }),
  new StringToken({ name: 'OR', match: 'or' }),
  new StringToken({ name: 'WHILE', match: 'while' }),
  new StringToken({ name: 'FOR', match: 'for' }),
  new StringToken({ name: 'TO', match: 'to' }),
  new StringToken({ name: 'STEP', match: 'step' }),
  new StringToken({ name: 'BREAK', match: 'break' }),
  new StringToken({ name: 'CONTINUE', match: 'continue' }),
  new StringToken({ name: 'IN', match: 'in' }),
  new StringToken({ name: 'TRUE', match: 'true' }),
  new StringToken({ name: 'YES', match: 'yes' }),
  new StringToken({ name: 'ON', match: 'on' }),
  new StringToken({ name: 'FALSE', match: 'false' }),
  new StringToken({ name: 'NO', match: 'no' }),
  new StringToken({ name: 'OFF', match: 'off' }),
