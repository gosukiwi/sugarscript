...
Type_Definition
  = ":" _ type:Identifier _ array:Parameter_Array_Braces? { return { type: type.value, array: +array } }
...
Function_Definition_Statement "def"
  = "def" __ name:Identifier _ "(" _ args:Parameter_List? _ ")" _ type:Type_Definition? _ Indent body:Statements Dedent
    { return { type: 'FUNCTION_DEFINITION', name: name.value, args, body, returnType: type || 'VOID' } }
...
Assignment "assignment"
  = lhs:Dot_Access _ "=" _ rhs:Expression _ EOS
...
// =====================================================================================================================
Let "let"
  = "let" __ name:Identifier _ ":" _ type:Identifier _ array:Parameter_Array_Braces? _ EOS
  { return { type: 'LET', name: name.value, value: type.value, array: +array } }
...
Function_Call "function call"
  ...
  { return { type: 'DOT_CALL', receiver: name, args: args } }
...
ArrayIdentifier_Array_Numbers
  = index:Literal _ "," _ indeces:ArrayIdentifier_Array_Numbers { return [index].concat(indeces) }
  / index:Literal { return [index] }
